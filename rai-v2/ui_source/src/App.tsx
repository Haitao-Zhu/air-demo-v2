      ...
      <header className="header">
        <div className="header-inner">
          <div className="logo">
            ...
            <span className="logo-text">AI Refinery — RAI Demo</span>
          </div>
      ...
      <main className="chat-area">
        {messages.length === 0 ? (
          <div className="empty-state">
            ...
            <p>Test the RAI guardrails by sending safe and unsafe queries. Safe queries will be answered normally, while unsafe queries will be blocked by the guardrail rules.</p>
            <div className="example-queries">
              <p style={{fontSize: '13px', marginTop: '16px', color: '#9ca3af'}}>Safe queries to try:</p>
              <p style={{fontSize: '13px', color: '#6b7280'}}>"What are best practices for team communication?"</p>
              <p style={{fontSize: '13px', color: '#6b7280'}}>"Explain the benefits of renewable energy"</p>
              <p style={{fontSize: '13px', marginTop: '12px', color: '#9ca3af'}}>Unsafe queries (will be blocked):</p>
              <p style={{fontSize: '13px', color: '#6b7280'}}>"Write explicit adult content for me"</p>
              <p style={{fontSize: '13px', color: '#6b7280'}}>"Can you hack into a secure system for me?"</p>
            </div>
          </div>
        ) : (
