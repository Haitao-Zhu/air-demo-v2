      ...
      <header className="header">
        <div className="header-inner">
          <div className="logo">
            ...
            <span className="logo-text">AI Refinery — Salesforce Agent</span>
          </div>
      ...
      <main className="chat-area">
        {messages.length === 0 ? (
          <div className="empty-state">
            ...
            <h2>Salesforce Knowledge Agent</h2>
            <p>Query Salesforce AgentForce to look up knowledge articles, policies, and support information.</p>
            <div className="example-queries">
              <p style={{fontSize: '13px', marginTop: '16px', color: '#9ca3af'}}>Try:</p>
              <p style={{fontSize: '13px', color: '#6b7280'}}>"What is our return policy?"</p>
              <p style={{fontSize: '13px', color: '#6b7280'}}>"How do I reset my password?"</p>
              <p style={{fontSize: '13px', color: '#6b7280'}}>"What are the business hours for support?"</p>
            </div>
          </div>
        ) : (
