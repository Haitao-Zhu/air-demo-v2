      ...
      <header className="header">
        <div className="header-inner">
          <div className="logo">
            ...
            <span className="logo-text">Cat Service Diagnostic</span>
          </div>
      ...
      <main className="chat-area">
        {messages.length === 0 ? (
          <div className="empty-state">
            ...
            <h2>Cat Service Diagnostic</h2>
            <p>Report a fault code and machine model to get a full diagnostic, parts availability check, and service report.</p>
            <div className="example-queries">
              <p style={{fontSize: '13px', marginTop: '16px', color: '#9ca3af'}}>Try:</p>
              <p style={{fontSize: '13px', color: '#6b7280'}}>"Fault code E101-3 on a Cat 320, engine misfiring"</p>
              <p style={{fontSize: '13px', color: '#6b7280'}}>"Fault code E102-1 on a Cat 330"</p>
            </div>
          </div>
        ) : (
