      ...
      <header className="header">
        <div className="header-inner">
          <div className="logo">
            ...
            <span className="logo-text">AI Refinery — Marketing Agents</span>
          </div>
      ...
      <main className="chat-area">
        {messages.length === 0 ? (
          <div className="empty-state">
            ...
            <h2>Marketing Campaign Generator</h2>
            <p>Multi-agent system that researches topics, develops marketing strategies, writes reports, and saves them locally.</p>
            <div className="example-queries">
              <p style={{fontSize: '13px', marginTop: '16px', color: '#9ca3af'}}>Try:</p>
              <p style={{fontSize: '13px', color: '#6b7280'}}>"Generate a marketing campaign for Agentic AI enterprise adoption"</p>
              <p style={{fontSize: '13px', color: '#6b7280'}}>"Create a go-to-market strategy for a new cloud security product"</p>
            </div>
          </div>
        ) : (
