...
def main():
    ...
    print("FlowSuperAgent — Intelligent Support Router")
    print("=" * 48)
    print("Example queries:")
    print('  "I\'m having a technical issue with my account, can you help?"')
    print('  "I was double-charged on my last invoice"')
    print('  "My app keeps crashing and I also need a refund"')
    print()
